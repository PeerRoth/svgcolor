...
function getLogoFile( ) {
    ...
    return { colors : arrayOfSvgColors , contents : svgContents , path : logoFile };
};
...
app.get( '/colors/:colorId' , function ( req , res ) {
    ...
    console.log( 'REPLACING ' + svgColors[ 0 ] + ' with ' + req.params.colorId );
    const newSvgContents =  svgContents.replace(
        new RegExp( svgColors[ 0 ] ) ,
        req.params.colorId )
